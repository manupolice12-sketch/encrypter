...
Files encrypted with versions prior to **v1.5.0** cannot be decrypted with this version due to the chunk-based compression format introduced in v1.4.0. Decrypt those files first before upgrading.
